...
local lua_builtin = {
	...
	["getgenv"] = true;["getrenv"] = true;["getsenv"] = true;["getreg"] = true;["getgc"] = true;["getinstances"] = true;["getnilinstances"] = true;["getscripts"] = true;["getloadedmodules"] = true;["getconnections"] = true;["firesignal"] = true;["fireclickdetector"] = true;["firetouchinterest"] = true;["getallthreads"] = true;["gettenv"] = true;["getclipboard"] = true;["getcustomasset"] = true;["writefile"] = true;["listfiles"] = true;["readfile"] = true;["appendfile"] = true;["loadfile"] = true;["dofile"] = true;["listfiles"]=true;["isfile"]=true;["isfolder"]=true;["makefolder"]=true;["zip_inflate"]=true;['delfolder']=true;['delfile']=true;['setfflag']=true;['cloneref']=true;['queue_on_teleport']=true;['identifyexecutor']=true;['gethui']=true;['setfpscap']=true;['getnetworkmode']=true;['setnetworkmode']=true;['isrbxactive']=true;['keypress']=true;['keyrelease']=true;['mouse1click']=true;['mouse1down']=true;['mouse1up']=true;['mouse2click']=true;['mouse2down']=true;['mouse2up']=true;['mousescroll']=true;['mousemoverel']=true;['mousemoveabs']=true;['checkcaller']=true;['hookfunction']=true;['decompile']=true;['rconsoleprint']=true;['rconsolewarn']=true;['rconsoleclear']=true;['rconsolename']=true;['rconsoleinput']=true;['rconsoleclose']=true;['request']=true;['getrawmetatable']=true;
	["os"] = true;
