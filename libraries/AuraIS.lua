...
v4.DragFunc = function(v21, v22, v23)
	...
	game:GetService("UserInputService").InputChanged:Connect(function(v50)
		if ((v50 == v25) and v24) then
			...
			game:GetService("TweenService"):Create(v23,TweenInfo.new(0.55,Enum.EasingStyle.Quint, Enum.EasingDirection.Out),{Position = UDim2.new(v27.X.Scale, v27.X.Offset + v117.X, v27.Y.Scale, v27.Y.Offset + v117.Y)}):Play();
		end
	end);
end;
...
local v16 = --[[loadstring(game:HttpGet("https://github.com/AnAvaragelilmemer/saturn/blob/main/libraries/aurais_internal.lua?raw=true"))() or]] game:GetObjects("rbxassetid://72566950615693")[1] 
v16.Enabled = false;
		...
		v80.CreateSection = function(v98, v99, v100)
			...
			v101.CreateParagraph = function(v212, v213)
				...
				v214.AutomaticSize = Enum.AutomaticSize.Y
        			...
        			v214.Title.Size = UDim2.new(1, -24, 0, v214.Title.TextBounds.Y)
        			v214.Size = UDim2.new(1, 0, 0, v214.Title.TextBounds.Y + 35)
    				end)
				v105();
			end;
